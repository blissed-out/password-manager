...
const Manager = () => {
  ...
  const edit = (id) => {
    console.log("Editing mode of id ", id);
    setform(PasswordArray.filter((i) => i.id === id)[0]);
    const updatedPasswordArray = PasswordArray.filter((i) => i.id !== id);
  ...
  return (
    <>
      ...
      <ToastContainer />
      <div className="p-4 md:p-0 mycontainer max-w-6xl">
        <div className="flex flex-col p-4">
          <h1 className="text-center text-4xl text-sky-400 font-bold">
              Passman :)
          </h1>
          <p className="text-center text-lg text-sky-600">
          ...
          <div className="flex flex-col text-black p-5 gap-6 items-center">
            <input
              ...
              className="rounded-full border border-yellow-600 w-full p-4 py-1"
              type="text"
            ...
            <div className="flex flex-col md:flex-row gap-6 w-full">
              <input
                ...
                name="username"
                onChange={handleChange}
                className="rounded-full border w-full border-yellow-600 p-4 py-1"
                type="text"
              ...
              <div className="relative">
                ...
                />
                <span
                  className="absolute right-[5px] top-[2px] cursor-pointer"
            ...
            <div className="button flex justify-center items-center bg-blue-800 hover:bg-blue-400 rounded-full px-6 py-2 cursor-pointer">
              <lord-icon
                ...
                trigger="hover"
              ></lord-icon>
              <button onClick={savePassword} className="text-white">
                Add Password
              </button>
            </div>
          </div>
        ...
        <div className="password">
          ...
          {PasswordArray.length === 0 && (
            <div className="text-slate-400 text-center py-36">
                  ...
                  return (
                    <tr>
                      ...
                      <td className="text-center relative">
                        {items.username}
                        <div
                          className="lordcopy flex cursor-pointer absolute top-0 right-0"
                          onClick={() => {
                      ...
                      <td className="text-center flex justify-center items-center relative">
                        {items.password}
                        <div
                          className="lordcopy flex cursor-pointer absolute right-0"
                          onClick={() => {
